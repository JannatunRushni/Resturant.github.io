                    ...
                    <form method="POST" action="{{ route('admin.categories.update',$category->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div>
                                ...
                                <img style="width: 100px; height:100px;" src="{{ Storage::url($category->image) }}">
                        ...
                        <div class="mt-6 p-4">
                            <button type="submit"
                                class="px-4 py-2 bg-indigo-700 hover:bg-indigo-700 rounded-lg text-white">Update</button>
                        </div>
                    </form>
                </div>
